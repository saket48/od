...
public class ChooseBookmarkDialog extends DialogFragment implements LoaderManager.LoaderCallbacks<List<BookmarkModel>> {
    ...
    public Loader<List<BookmarkModel>> onCreateLoader(int id, Bundle args) {
        return new BookmarkLoader(requireActivity(), true);
    }
     ...
     */
    @Override
    public void onLoadFinished(@NonNull Loader<List<BookmarkModel>> loader, List<BookmarkModel> data) {
     ...
     */
    @Override
    public void onLoaderReset(@NonNull Loader<List<BookmarkModel>> loader) {
